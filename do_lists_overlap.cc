...
shared_ptr<ListNode<int>> OverlappingLists(shared_ptr<ListNode<int>> l0,
  ...
  /*
   * One or both the lists may have cycles in them.
   * Why wouldn't the earlier method work ? Because we can't find the
   * end of the list.
   *
   * This wouldn't give us the correct answer.
   *
   * Any node in the overlap can be returned.
   *
   * */
