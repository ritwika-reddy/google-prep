...
shared_ptr<ListNode<int>> ListPivoting(const shared_ptr<ListNode<int>>& l,
                                       int x) {
  shared_ptr<ListNode<int>> curr = l, dummy_less(new ListNode<int>),
  dummy_equal(new ListNode<int>), dummy_more(new ListNode<int>);
  auto less = dummy_less;
  auto equal = dummy_equal;
  auto more = dummy_more;
